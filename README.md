...
The current 5.x series of ios-sim is effectively a new package. It has been rewritten from scratch as a Node.js module, and lacks the ability to [log standard output](https://github.com/phonegap/ios-sim/issues/181) or exit when the launched process exits.
